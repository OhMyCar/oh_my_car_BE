...
public class CustomerController {
    ...
    public ResponseEntity<Customer> update(@RequestHeader String token, @RequestBody CustomerUpdateForm form, @PathVariable Long id) {
        return ResponseEntity.ok(customerService.update(form, id));
    }
}
